                        ...
                        <div class="inside">
							...
							<tr>
								...
								<td>
									<fieldset>
										...
										<label>
											<input type="radio" name="emailNotification" value="<?php echo WpTrivia_Model_Quiz::QUIZ_EMAIL_NOTE_NONE; ?>" <?php $this->checked($this->quiz->getEmailNotification(),
                                    WpTrivia_Model_Quiz::QUIZ_EMAIL_NOTE_NONE); ?>>
											<?php _e('Deactivate', 'wp-trivia'); ?>
										</label>
										<label>
											<input type="radio" name="emailNotification" value="<?php echo WpTrivia_Model_Quiz::QUIZ_EMAIL_NOTE_REG_USER; ?>" <?php $this->checked($this->quiz->getEmailNotification(),
                                    WpTrivia_Model_Quiz::QUIZ_EMAIL_NOTE_REG_USER); ?>>
											<?php _e('for registered users only', 'wp-trivia'); ?>
										</label>
										<label>
											<input type="radio" name="emailNotification" value="<?php echo WpTrivia_Model_Quiz::QUIZ_EMAIL_NOTE_ALL; ?>" <?php $this->checked($this->quiz->getEmailNotification(),
							...
							<tr>
							 ...
							 -->
                                <tr>
                                    <th scope="row">
                                        <?php _e('Autostart', 'wp-trivia'); ?>
                                    </th>
                                    <td>
                                        <fieldset>
                                            <legend class="screen-reader-text">
                                                <span><?php _e('Autostart', 'wp-trivia'); ?></span>
                                            </legend>
                                            <label>

 ...
 */
class WpTrivia_View_AdminToplist extends WpTrivia_View_View
{
                ...
                <div class="postbox">
                    ...
                    <div class="inside">
                        <ul>
                                    ...
                                    <select id="wpTrivia_sorting">
                                        <option
                                            value="<?php echo WpTrivia_Model_Quiz::QUIZ_TOPLIST_SORT_BEST; ?>"><?php _e('best user',
                                                'wp-trivia'); ?></option>
                                        <option
                                            value="<?php echo WpTrivia_Model_Quiz::QUIZ_TOPLIST_SORT_NEW; ?>"><?php _e('newest entry',
                                                'wp-trivia'); ?></option>
                                        <option
                                            value="<?php echo WpTrivia_Model_Quiz::QUIZ_TOPLIST_SORT_OLD; ?>"><?php _e('oldest entry',
                                                'wp-trivia'); ?></option>
                                    </select>
                                </label>
                            </li>
                            ...
                            <li>
                                <span style="font-weight: bold;"><?php _e('Type', 'wp-trivia'); ?>
                                    :</span> <?php _e('UR = unregistered user, R = registered user', 'wp-trivia'); ?>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div id="wpTrivia_content">
                <table class="wp-list-table widefat" id="wpTrivia_toplistTable">
                    ...
                    <tr>
                        ...
                        <th scope="col" width="150px"><?php _e('Entered on', 'wp-trivia'); ?></th>
                        <th scope="col" width="70px"><?php _e('Points', 'wp-trivia'); ?></th>
                        <th scope="col" width="100px"><?php _e('Results', 'wp-trivia'); ?></th>
                    </tr>
                    </thead>
                    <tbody id="">
                    <tr style="display: none;">
                        ...
                        <td>
                            ...
                            <div class="inline-edit" style="margin-top: 10px; display: none;">
                                <input type="button" value="<?php _e('save', 'wp-trivia'); ?>"
                                       class="button-secondary inline_editSave">
                                <input type="button" value="<?php _e('cancel', 'wp-trivia'); ?>"

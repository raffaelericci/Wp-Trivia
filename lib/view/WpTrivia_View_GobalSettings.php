 ...
 * @property WpTrivia_Model_Template[] templateQuestion
 * @property string toplistDataFormat
 * @property string statisticTimeFormat
 */
class WpTrivia_View_GobalSettings extends WpTrivia_View_View
{
    ...
    private function globalSettings()
    {
        ...
        ?>
        <div class="postbox">
            <h3 class="hndle"><?php _e('Global settings', 'wp-trivia'); ?></h3>
            ...
            <div class="inside">
                <table class="form-table">
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Leaderboard time format', 'wp-trivia'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Leaderboard time format', 'wp-trivia'); ?></span>
                                </legend>
                                <label>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Statistic time format', 'wp-trivia'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Statistic time format', 'wp-trivia'); ?></span>
                                </legend>

                                <label>
                                    <?php _e('Select example:', 'wp-trivia'); ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Quiz template management', 'wp-trivia'); ?></span>
                                </legend>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Question template management', 'wp-trivia'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Question template management', 'wp-trivia'); ?></span>
                                </legend>
                ...
                <table class="form-table">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div>
                                <h4><?php _e('Allowed variables', 'wp-trivia'); ?>:</h4>
                                <ul>
                                    <li><span>$userId</span> - <?php _e('User-ID', 'wp-trivia'); ?></li>
                                    <li><span>$username</span> - <?php _e('Username', 'wp-trivia'); ?></li>
                                    <li><span>$quizname</span> - <?php _e('Quiz-Name', 'wp-trivia'); ?></li>
    ...
    {
        if ($this->isRaw) {
            $rawSystem = __('to activate', 'wp-trivia');
        } else {
            $rawSystem = __('not to activate', 'wp-trivia');
        }

        ?>

        <div class="updated" id="problemInfo" style="display: none;">
            <h3><?php _e('Please note', 'wp-trivia'); ?></h3>

            <p>
                <?php _e('These settings should only be set in cases of problems with Wp-Trivia.', 'wp-trivia'); ?>
            </p>
        </div>

        <h3 class="hndle"><?php _e('Settings in case of problems', 'wp-trivia'); ?></h3>
        <div class="inside">
            <table class="form-table">
                <tbody>
                <tr>
                    <th scope="row">
                        <?php _e('Automatically add [raw] shortcode', 'wp-trivia'); ?>
                    </th>
                    <td>
                        <fieldset>
                            <legend class="screen-reader-text">
                                <span><?php _e('Automatically add [raw] shortcode', 'wp-trivia'); ?></span>
                            </legend>
                            <label>
                                <input type="checkbox" value="1"
                                       name="addRawShortcode" <?php echo $this->settings->isAddRawShortcode() ? 'checked="checked"' : '' ?> >
                                <?php _e('Activate', 'wp-trivia'); ?> <span
                            ...
                            <p class="description">
                                <?php _e('If this option is activated, a [raw] shortcode is automatically set around WpTrivia shortcode ( [WpTrivia X] ) into [raw] [WpTrivia X] [/raw]',
                                    'wp-trivia'); ?>
                            </p>
                ...
                <tr>
                    <th scope="row">
                        <?php _e('Do not load the Javascript-files in the footer', 'wp-trivia'); ?>
                    </th>
                    <td>
                        <fieldset>
                            <legend class="screen-reader-text">
                            ...
                            <p class="description">
                                <?php _e('Generally all WpTrivia-Javascript files are loaded in the footer and only when they are really needed.',
                                    'wp-trivia'); ?>
                            </p>

                            <p class="description">
                                <?php _e('In very old Wordpress themes this can lead to problems.', 'wp-trivia'); ?>
                            </p>

                            <p class="description">
                                <?php _e('If you activate this option, all WpTrivia-Javascript files are loaded in the header even if they are not needed.',
                                    'wp-trivia'); ?>
                            </p>
                ...
                <tr>
                    <th scope="row">
                        <?php _e('Touch Library', 'wp-trivia'); ?>
                    </th>
                    <td>
                        <fieldset>
                            <legend class="screen-reader-text">
                                <span><?php _e('Touch Library', 'wp-trivia'); ?></span>
                            </legend>
                            <label>
                                <input type="checkbox" value="1"
                ...
                <tr>
                    <th scope="row">
                        <?php _e('jQuery support cors', 'wp-trivia'); ?>
                    </th>
                    <td>
                        <fieldset>
                            <legend class="screen-reader-text">
                                <span><?php _e('jQuery support cors', 'wp-trivia'); ?></span>
                            </legend>
                            <label>
                                <input type="checkbox" value="1"
                            ...
                            <p class="description">
                                <?php _e('Is required only in rare cases.', 'wp-trivia'); ?>
                            </p>
                ...
                <tr>
                    <th scope="row">
                        <?php _e('Repair database', 'wp-trivia'); ?>
                    </th>
                    <td>
                        <fieldset>
                            <legend class="screen-reader-text">
                                <span><?php _e('Repair database', 'wp-trivia'); ?></span>
                            </legend>

...
class WpTrivia_Helper_Export
{
    ...
    public function export($ids)
    {
        ...
        $export['exportVersion'] = WpTrivia_Helper_Export::WPPROQUIZ_EXPORT_VERSION;
        $export['date'] = time();

        $v = str_pad(WPPROQUIZ_VERSION, 5, '0', STR_PAD_LEFT);
        $v .= str_pad(WpTrivia_Helper_Export::WPPROQUIZ_EXPORT_VERSION, 5, '0', STR_PAD_LEFT);
        $code = 'WPQ' . $v;

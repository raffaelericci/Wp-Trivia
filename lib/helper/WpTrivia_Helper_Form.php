...
class WpTrivia_Helper_Form
{

    /**
     *
     * @param WpTrivia_Model_Form $form
     * @param mixed $data
     *
     * @return bool
     */
    ...
    public static function formToString(WpTrivia_Model_Form $form, $str)
    {
        switch ($form->getType()) {
            case WpTrivia_Model_Form::FORM_TYPE_TEXT:
            case WpTrivia_Model_Form::FORM_TYPE_TEXTAREA:
            ...
            case WpTrivia_Model_Form::FORM_TYPE_SELECT:
                ...
                break;
            case WpTrivia_Model_Form::FORM_TYPE_CHECKBOX:
                return $str == '1' ? __('ticked', 'wp-trivia') : __('not ticked', 'wp-trivia');
                break;
            case WpTrivia_Model_Form::FORM_TYPE_YES_NO:

...
class WpTrivia_Helper_Captcha
{
    ...
    /**
     * @return WpTrivia_Helper_Captcha
     */
    public static function getInstance()
    {
        if (WpTrivia_Helper_Captcha::$INSTANCE == null) {
            WpTrivia_Helper_Captcha::$INSTANCE = new WpTrivia_Helper_Captcha();
        }

        return WpTrivia_Helper_Captcha::$INSTANCE;
    }
}
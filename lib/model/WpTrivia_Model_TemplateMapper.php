...
class WpTrivia_Model_TemplateMapper extends WpTrivia_Model_Mapper
{

    /**
     * @param WpTrivia_Model_Template $template
     * @return WpTrivia_Model_Template
     */
    ...
    public function fetchAll($type, $loadData = true)
    {
        ...
        foreach ($result as $row) {
            ...
            $template = new WpTrivia_Model_Template($row);

            if ($loadData && WpTrivia_Helper_Until::saveUnserialize($data, $into)) {
    ...
    public function fetchById($templateId, $loadData = true)
    {
        ...
        return new WpTrivia_Model_Template();
    }
}
...
class WpTrivia_Model_Email extends WpTrivia_Model_Model
{
    protected $_to = '';
    ...
    {
        $email = new WpTrivia_Model_Email();

        if ($adminEmail) {
            $email->setSubject(__('Wp-Trivia: One user completed a quiz', 'wp-trivia'));
            $email->setMessage(__('Wp-Trivia

...
class WpTrivia_Model_StatisticRefMapper extends WpTrivia_Model_Mapper
{
    ...
    public function fetchAll($quizId, $userId, $testId = 0)
    {
        ...
        foreach ($results as $row) {
            ...
            $r[] = new WpTrivia_Model_StatisticRefModel($row);
        }
    ...
    public function fetchByRefId($refIdUserId, $quizId, $avg = false)
    {
        ...
        foreach ($results as $row) {
            ...
            return new WpTrivia_Model_StatisticRefModel($row);
        }
    ...
    public function fetchAvg($quizId, $userId)
    {
        ...
        foreach ($results as $row) {
            $r[] = new WpTrivia_Model_Statistic($row);
        }
    ...
    public function fetchOverview($quizId, $onlyCompleded, $start, $limit)
    {
        ...
        foreach ($results as $row) {
            ...
            $a[] = new WpTrivia_Model_StatisticOverview($row);
        }
    ...
    /**
     *
     * @param WpTrivia_Model_StatisticRefModel $statisticRefModel
     * @param WpTrivia_Model_Statistic[] $statisticModel
     */
...
// 		}
    ...
    public function fetchFormOverview($quizId, $page, $limit, $onlyUser = 0)
    {
        ...
        foreach ($result as $row) {
            ...
            $r[] = new WpTrivia_Model_StatisticFormOverview($row);
        }
     ...
     * @param int $startTime
     * @param int $endTime
     * @return WpTrivia_Model_StatisticHistory[]
     */
    public function fetchHistory($quizId, $page, $limit, $users = -1, $startTime = 0, $endTime = 0)
    {
        ...
        foreach ($result as $row) {
            ...
            $r[] = new WpTrivia_Model_StatisticHistory($row);
        }

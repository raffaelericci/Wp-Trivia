...
class WpTrivia_Model_LockMapper extends WpTrivia_Model_Mapper
{
    protected $_table;
    ...
    /**
     * @param WpTrivia_Model_Lock $lock
     *
     * @return false|int
     */
    public function insert(WpTrivia_Model_Lock $lock)
    {
     ...
     * @param int $userId
     *
     * @return null|WpTrivia_Model_Lock
     */
    public function fetch($quizId, $lockIp, $userId)
    {
        ...
        return $row !== null ? new WpTrivia_Model_Lock($row) : null;
    }
